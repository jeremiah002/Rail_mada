...
import logodown from "../assets/logdown.png";
    ...
    <>
      ...
      >
        ...
        >
          ...
          <hr
            className={`border-b ${
              scrolled ? "border-gray-800" : "border-gray-100"
          ...
          <div className="container mx-auto px-8">
            <div className="w-full flex flex-col md:flex-row py-6">
              <div className="flex-1 mb-6 text-black">
                <a
                  className="text-pink-600 no-underline hover:no-underline font-bold text-2xl lg:text-4xl mr-2"
                  href="#"
                >
                  <img
                    src={logodown}
                    className="fill-current inline w-10 pb-4 mr-2"
                  />
                  RAIL'S MADA
                </a>
              </div>
