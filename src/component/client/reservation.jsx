...
const Reservation = () => {
  ...
  const handleDocumentClick = (e) => {
    if (!e.target.closest('#nav-content') && !e.target.closest('#nav-toggle')) {
        ...
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
          <div className="pl-4 flex items-center">
            <a className="toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
              <img id="rectangle" src={logo} className="fill-current inline w-10 pb-2" alt="Logo" />
              RAIL'S MADA
            </a>
          </div>
          ...
          <div
            className={`w-full flex-grow lg:flex lg:items-center lg:w-auto ${navMenuVisible ? '' : 'hidden'} mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20`}
            id="nav-content"
          >
            <ul className="list-reset lg:flex justify-end flex-1 items-center">
              <li className="mr-3">
                <a className="inline-block py-2 px-4 text-white font-bold no-underline" href="#" id="acc">
                  Acceuil
                </a>
              </li>
              <li className="mr-3">
                  ...
                  <div className="border-b border-gray-900/10 pb-12">
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                      ...
                      <div className="col-span-full">
                        <label htmlFor="annonce" className="block text-sm font-medium leading-6 text-gray-900">
                          Autres annonces
                        </label>
                        <div className="mt-2">
                          <textarea
                            ...
                            name="annonce"
                            rows="3"
                            className="block w-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:py-1.5 pl-2 placeholder:text-gray-400 sm:text-sm sm:leading-6"
                          ></textarea>
                        </div>
                      </div>
                    </div>
